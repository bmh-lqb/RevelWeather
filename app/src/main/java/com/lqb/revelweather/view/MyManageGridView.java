...
public class MyManageGridView extends GridView {
    public OnTouchInvalidPositionListener mTouchInvalidPosListener;

    public MyManageGridView(Context context) {
        super(context);
    }

    public MyManageGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MyManageGridView(Context context, AttributeSet attrs, int defStyleAttr) {
